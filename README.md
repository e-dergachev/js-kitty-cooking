...
To run the both front-end and back-end in the dev mode you may use the following command: 'concurrently "npm run server" "npm start"' (you should have concurrently npm package being installed).
